function [] = function_sim_2C_wo_trans_XAtot2_k1XAtdep_161202(inputFilename,outputFilename)
...
second_chr = 1;
k_adv_sil = 1;
const_par = [t_start, t_before, t_diff, sil_threshold, output_time_step, second_chr, k_adv_sil];
nr_cells = 100;
