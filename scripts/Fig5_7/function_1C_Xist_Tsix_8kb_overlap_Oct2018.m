function [] = function_1C_Xist_Tsix_8kb_overlap_Oct2018(inputFilename,outputFilename)
...
[t,xp1,tp1,xr1,tr1,xp2,tp2,xr2,tr2,test] = reaction_bifurc_bas_trans_XAtot2_161130(p, const_par, ...
...
r = floor(length(Xist_C1)*v*p(1));
q = randsample(length(Xist_C1),r);
Xist_C1(q) = 1;

Xist_RNA_C1 = floor(p(1)/p(4));
Tsix_RNA_C1 = 0;
