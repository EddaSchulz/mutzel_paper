### Simulate polyploid cells with XA dilution hypothesis in stochastic Gillespie model
...
@time for n=1:size(pars,1)
  ...
  ma_scan[(n-1)*nr_cells+1:n*nr_cells,34:33+4*(Int64(t)+1)] = sim_ba_gil_polypl_dil(p,nr_cells,t)
end
